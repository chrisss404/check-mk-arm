...
##### Raspberry Pi OS (32-bit) Bullseye
    ...
    curl -LO $(curl -s https://api.github.com/repos/chrisss404/check-mk-arm/releases/tags/2.1.0p5 | grep browser_download_url | cut -d '"' -f 4 | grep bullseye_armhf.deb) 
...
* Checkmk 2.1.0 for Raspberry Pi OS Bullseye: [2.1.0p5](https://github.com/chrisss404/check-mk-arm/releases/tag/2.1.0p5)
