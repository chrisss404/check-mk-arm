...
##### Raspberry Pi OS Buster (armhf)
    ...
    curl -LO $(curl -s https://api.github.com/repos/chrisss404/check-mk-arm/releases/tags/2.0.0p2 | grep browser_download_url | cut -d '"' -f 4 | grep buster_armhf.deb) 
    dpkg -i check-mk-raw-*.buster_armhf.deb
    apt-get install -f

##### Ubuntu Groovy (arm64)

    curl -LO $(curl -s https://api.github.com/repos/chrisss404/check-mk-arm/releases/tags/2.0.0p2 | grep browser_download_url | cut -d '"' -f 4 | grep groovy_arm64.deb) 
    dpkg -i check-mk-raw-*.groovy_arm64.deb
    apt-get install -f

##### Ubuntu Focal (arm64)

    curl -LO $(curl -s https://api.github.com/repos/chrisss404/check-mk-arm/releases/tags/2.0.0p2 | grep browser_download_url | cut -d '"' -f 4 | grep focal_arm64.deb) 
...
* Checkmk 2.0.0 for Raspberry Pi OS Buster: [2.0.0p2](https://github.com/chrisss404/check-mk-arm/releases/tag/2.0.0p2)
...
* Checkmk 2.0.0 for Ubuntu 20.10 Groovy: [2.0.0p2](https://github.com/chrisss404/check-mk-arm/releases/tag/2.0.0p2)
* Checkmk 2.0.0 for Ubuntu 20.04 Focal: [2.0.0p2](https://github.com/chrisss404/check-mk-arm/releases/tag/2.0.0p2)
