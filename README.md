...
##### Raspberry Pi OS Bullseye (armhf)
    ...
    curl -LO $(curl -s https://api.github.com/repos/chrisss404/check-mk-arm/releases/tags/2.0.0p20 | grep browser_download_url | cut -d '"' -f 4 | grep bullseye_armhf.deb) 
    dpkg -i check-mk-raw-*.bullseye_armhf.deb
    apt-get install -f

##### Ubuntu Impish (arm64)

    curl -LO $(curl -s https://api.github.com/repos/chrisss404/check-mk-arm/releases/tags/2.0.0p19 | grep browser_download_url | cut -d '"' -f 4 | grep impish_arm64.deb) 
    dpkg -i check-mk-raw-*.impish_arm64.deb
    apt-get install -f

##### Ubuntu Hirsute (arm64)

    curl -LO $(curl -s https://api.github.com/repos/chrisss404/check-mk-arm/releases/tags/2.0.0p19 | grep browser_download_url | cut -d '"' -f 4 | grep hirsute_arm64.deb) 
...
##### Ubuntu Focal (arm64)
    ...
    curl -LO $(curl -s https://api.github.com/repos/chrisss404/check-mk-arm/releases/tags/2.0.0p19 | grep browser_download_url | cut -d '"' -f 4 | grep focal_arm64.deb) 
...
* Checkmk 2.0.0 for Raspberry Pi OS Bullseye: [2.0.0p20](https://github.com/chrisss404/check-mk-arm/releases/tag/2.0.0p20)
...
* Checkmk 2.0.0 for Ubuntu 21.10 Impish: [2.0.0p19](https://github.com/chrisss404/check-mk-arm/releases/tag/2.0.0p19)
* Checkmk 2.0.0 for Ubuntu 21.04 Hirsute: [2.0.0p19](https://github.com/chrisss404/check-mk-arm/releases/tag/2.0.0p19)
* Checkmk 2.0.0 for Ubuntu 20.04 Focal: [2.0.0p19](https://github.com/chrisss404/check-mk-arm/releases/tag/2.0.0p19)
...
### Build Checkmk from sources
    ...
    # build a specific version of Checkmk targeting Groovy, e.g.: 2.0.0p19
