...
##### Raspberry Pi OS Bullseye (armhf)
    ...
    curl -LO $(curl -s https://api.github.com/repos/chrisss404/check-mk-arm/releases/tags/2.0.0p18 | grep browser_download_url | cut -d '"' -f 4 | grep bullseye_armhf.deb) 
...
* Checkmk 2.0.0 for Raspberry Pi OS Bullseye: [2.0.0p18](https://github.com/chrisss404/check-mk-arm/releases/tag/2.0.0p18)
